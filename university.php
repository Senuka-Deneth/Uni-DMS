    ...
    <section class="page-hero reveal-on-scroll detail-hero">
        <div class="container hero-detail">
            ...
            <div class="hero-media">
                ...
                <?php if ($heroImage): ?>
                    <img src="<?php echo $heroImage; ?>" alt="<?php echo htmlspecialchars($university['name']); ?>" loading="lazy">
                <?php else: ?>
...
<?php if ($university): ?>
    ...
    <section class="container reveal-on-scroll">
        ...
        <?php else: ?>
            <p class="section-subtitle">No cataloged degrees are visible right now. Check back after our next update.</p>
        <?php endif; ?>
    </section>
<?php else: ?>
    <section class="page-hero reveal-on-scroll">
        <div class="container">
            <p class="eyebrow">University not found</p>
            <h1>We could not locate that university.</h1>
            <p class="page-hero-meta">Return to the directory to continue your exploration.</p>
            <div class="breadcrumb">
                <a href="/index.php">Home</a>
                <span> / </span>
                <a href="/universities.php">Universities</a>
